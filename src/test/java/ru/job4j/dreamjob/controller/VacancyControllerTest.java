...
public class VacancyControllerTest {
    ...
    @Test
    public void whenRequestVacancyGetOneCandidate() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
    ...
    @Test
    public void whenRequestDeleteOneVacancy() {

        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var expectedVacancies = List.of(vacancy);
        when(vacancyService.findAll()).thenReturn(expectedVacancies);
    ...
    @Test
    public void whenRequestUpdateOneVacancy() throws IOException {
